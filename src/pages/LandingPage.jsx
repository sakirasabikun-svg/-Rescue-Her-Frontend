...
// // 1. এখানে FeaturesPage ইমপোর্ট করা হলো
...
//   // 2. ইউজার ফিচারস পেজে আছে নাকি হোম পেজে তা ট্র্যাক করার স্টেট
...
//         ) : (
//           <SignupView 
//             onSignupSuccess={(userName) => onExplore(userName)}
...
//   // 3. যদি ইউজার Features এ ক্লিক করে, তবে আলাদা ফিচারস পেজ রিটার্ন করবে
//   if (currentSubView === 'features') {
//     return <FeaturesPage onBackToHome={() => setCurrentSubView('home')} />;
//   }

//   return (
//     <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#fcfcfb', minHeight: '100vh', color: '#093325', overflowX: 'hidden' }}>
...
//       {/* 🧭 PREMIUM NAVBAR */}
//       <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '24px 6%', background: '#fcfcfb', position: 'sticky', top: 0, zIndex: 100, borderBottom: '1px solid rgba(9, 51, 37, 0.05)' }}>
...
//             {/* 4. এখানে Features লিংকটিকে ক্লিকেবল স্প্যান বানানো হলো */}
//             <span 
...
//               Features
//             </span>
//             <a href="#network" style={{ textDecoration: 'none', color: '#5c726a', fontSize: '14px', fontWeight: '600' }}>Network Matrix</a>
//             <a href="#faq" style={{ textDecoration: 'none', color: '#5c726a', fontSize: '14px', fontWeight: '600' }}>FAQ</a>
//           </div>
//         </div>
...
//               boxShadow: '0 4px 14px rgba(9, 51, 37, 0.15)'
//             }}
//           >
...
//       {/* 🚀 HERO SECTION */}
//       <section style={{ padding: '60px 6% 100px 6%', display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: '60px', alignItems: 'center' }}>
//         <div style={{ textAlign: 'left', animation: 'contentFadeIn 1s ease-out 2.2s both' }}>
//           <div style={{ padding: '6px 14px', background: '#eef5f2', color: '#093325', borderRadius: '50px', fontSize: '12px', fontWeight: '700', display: 'inline-block', marginBottom: '24px', letterSpacing: '0.5px' }}>
//             SECURE CIVILIAN GRID OPERATIONAL
//           </div>
//           <h1 style={{ fontSize: '68px', fontWeight: '800', color: '#093325', lineHeight: '1.1', letterSpacing: '-2.5px', margin: '0 0 32px 0' }}>
//             Change the way <br />you use your <br /><span style={{ fontStyle: 'italic', fontWeight: '400', fontFamily: 'Georgia, serif', color: '#10b981' }}>security.</span>
//           </h1>
...
//               if (isLoggedIn) { setActiveView('Dashboard'); } else { setAuthView('login'); }
//             }}
//             style={{ padding: '18px 38px', background: '#093325', color: '#fff', border: 'none', borderRadius: '50px', fontSize: '15px', fontWeight: '600', cursor: 'pointer', transition: 'all 0.2s ease', boxShadow: '0 6px 20px rgba(9, 51, 37, 0.2)' }}
//           >
...
//           <div style={{ background: '#eef2ef', borderRadius: '24px', padding: '36px', minHeight: '280px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gridRow: 'span 2' }}>
//             <span style={{ fontSize: '44px' }}>🛡️</span>
//             <div>
//               <h4 style={{ margin: '0 0 8px 0', fontSize: '22px', fontWeight: '700', color: '#093325' }}>Active Nodes</h4>
//               <p style={{ margin: 0, fontSize: '14px', color: '#5c726a', lineHeight: '1.4' }}>Real-time satellite matrix sync layer active.</p>
//             </div>
//           </div>
          
//           <div style={{ background: '#f4f6f4', borderRadius: '24px', padding: '32px', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
//             <h2 style={{ fontSize: '52px', margin: 0, fontWeight: '800', color: '#093325' }}>99.9%</h2>
//             <p style={{ margin: '6px 0 0 0', fontSize: '14px', color: '#5c726a', fontWeight: '500' }}>Signal Uptime Matrix</p>
//           </div>

//           <div style={{ background: '#093325', color: '#fff', borderRadius: '24px', padding: '32px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
...
//       {/* CARDS SECTION */}
//       <section style={{ padding: '100px 6%', background: '#ffffff', borderTop: '1px solid #f0f0ee' }}>
...
//       {/* CTA BANNER */}
//       <section style={{ padding: '0 6% 60px 6%', background: '#ffffff' }}>
...
//       {/* FOOTER */}
//       <footer style={{ padding: '80px 6% 40px 6%', background: '#fcfcfb', borderTop: '1px solid #e8ece9' }}>
...
//             {/* 5. FAQ লিংকটিকে বাটন/স্প্যান বানিয়ে ক্লিকেবল করা হলো */}
//             <span 
...
//       <section id="network" style={{ padding: '100px 6%', background: '#f4f6f4', borderTop: '1px solid #e8ece9', textAlign: 'center', scrollMarginTop: '80px' }}>
...
//       {/* CTA BANNER */}
//       <section style={{ padding: '80px 6% 60px 6%', background: '#ffffff' }}>
//         <div style={{ background: '#093325', color: '#fff', borderRadius: '24px', padding: '80px 60px', display: 'grid', gridTemplateColumns: '1.6fr 1fr', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
//           <div>
//             <h2 style={{ fontSize: '48px', fontWeight: '800', margin: '0 0 16px 0', lineHeight: '1.2', letterSpacing: '-1px' }}>Change the way you <br />use your safety armor.</h2>
//             <p style={{ color: '#a2b7b0', fontSize: '15px', margin: '0 0 36px 0', maxWidth: '460px', lineHeight: '1.5' }}>Join thousands of verified active nodes who trust RescueHer safety system ecosystem for fast, fully private and resilient decentralized assistance.</p>
